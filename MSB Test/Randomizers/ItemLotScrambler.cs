...
namespace MSB_Test.Randomizers
{
    public class ItemLotScrambler
    {
        ...
        public ItemLotScrambler(string filePath, ref Random rand, bool workshopBool = false, bool logging = true)
        {
            this.filePath = filePath;
            this.logging = logging;
            this.rand = rand;

            nonoItemLots = GetNoNoItemLots();
            keyItemLots = GetKeyItemLots();
            workshopItemsList = GetWorkshopItemLots();
        ...
        public static List<int> GetNoNoItemLots()
        {
            return new List<int>
            {
        ...
        public static List<int> GetKeyItemLots()
        {
            return new List<int>
            {
        ...
        public static List<int> GetWorkshopItemLots()
        {
            return new List<int>
            {
        ...
        {
            var itemLotList = GetItemLotListFromMaps(maps, nonoItemLots);
        ...
        public static List<int> GetItemLotListFromMaps(List<string> maps, List<int> nonoItemLots = null)
        {
            nonoItemLots = nonoItemLots ?? new List<int>(); // If its null, new it up to avoid crash.  
        ...
        private static List<int> GenerateItemLotList(string currentMap, List<int> nonoItemLots)
        {
